...
function mapFareCabinToSeatClass(cabinClass?: string | null): "economy" | "business" {
    return String(cabinClass || "").toUpperCase() === "BUSINESS" ? "business" : "economy";
}
                    ...
                    <aside className="lg:sticky lg:top-24">
                        <section className="rounded-[24px] border border-slate-200/90 bg-white/95 p-6 shadow-[0_20px_48px_rgba(15,23,42,0.08)] backdrop-blur-sm flex flex-col h-full">
                            ...
                            <div className="mt-8 space-y-3">
                                <button
                                    onClick={() => router.push(`/user/bookings/seat-map?tripId=${flight._id}&class=${mapFareCabinToSeatClass(selectedFare?.cabin_class)}&type=flight`)}
